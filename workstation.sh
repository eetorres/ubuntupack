...
#Xft provides a client-side font API for X applications, making the #FreeType font rasterizer available to X clients. Fontconfig is used #for font specification resolution. Where available, the RENDER #extension handles glyph drawing; otherwise, the core X protocol is #used. This package provides a static library and C header files. 
